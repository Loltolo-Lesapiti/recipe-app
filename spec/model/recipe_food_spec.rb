...
RSpec.describe RecipeFood, type: :model do
  recipe = Recipe.new(name: 'Pilau', preparation_time: 2, cooking_time: 1, description: 'Pour water and some rice',
                      public: true)
  food = Food.new(name: 'Pilau', measurement_unit: 'grams', price: 20)

  subject { RecipeFood.new(quantity: 2, food_id: food.id, recipe_id: recipe.id) }
  before { subject.save }
